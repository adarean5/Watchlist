 ...
 */
public class LoginActivityMain extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private final String loginUrl = "http://ismoviesrest.azurewebsites.net/Movies.svc/Login";
    ...
    public void restLogin(final String username, final String pass) {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, loginUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                bundle.putString("Login.username", username);
                bundle.putString("Login.pass", pass);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(LoginActivityMain.this,
